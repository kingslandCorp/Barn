        ...
        <div className="mx-auto grid max-w-content gap-12 px-5 sm:px-8 md:grid-cols-2 lg:px-12">
          <Reveal>
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-cream/80 sm:text-lg">
              Dramatic cliffs, sleepy market towns, cosy pubs and some of the best sunsets in
              Wales — the Vale of Glamorgan rewards guests who venture just a little further than
              the garden gate.
            </p>
            <Link
              href="/explore"
